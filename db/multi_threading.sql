CREATE DATABASE  IF NOT EXISTS `multi_threading` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_general_ci */;
USE `multi_threading`;
-- MySQL dump 10.13  Distrib 5.5.16, for Win32 (x86)
--
-- Host: localhost    Database: multi_threading
-- ------------------------------------------------------
...
-- Dump completed on 2015-08-28 23:50:25
